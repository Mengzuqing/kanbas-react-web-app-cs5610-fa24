  ...
  updateCourse: () => void; })
 {
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      setFilteredCourses(userCourses.length > 0 ? userCourses : courses);
    } else {
    ...
    <div id="wd-dashboard">
      ...
      <h5>New Course
          ...
          <button className="btn btn-warning float-end me-2"
                onClick={() => {
                  updateCourse();
                  setFilteredCourses(filteredCourses.map(c => c._id === course._id ? course : c));
      ...
      <br />
      <input 
             value={course.name} className="form-control mb-2" 
