  ...
  return (
    <div id="wd-courses-navigation" className="wd list-group fs-5 rounded-0">
      ...
      <Link to="/Kanbas/Courses/1234/Zoom" id="wd-course-zoom-link"
        className="list-group-item text-danger border border-0"> Zoom Meetings </Link>
      ...
      <Link to="/Kanbas/Courses/1234/Grades" id="wd-course-people-link"
      ...
      <Link to="/Kanbas/Courses/1234/Settings" id="wd-course-people-link"
