...
import AssignmentControls from "./AssignmentControls";  // 确保路径正确
...
export default function Assignments() {
    ...
    const handleAddAssignment = () => {
        ...
        // 这里可以添加实际的逻辑，例如调用 API 或打开一个模态框以添加新任务
    };
                    ...
                    <li className="wd-assignment-lists list-group-item p-0 mb-5 fs-5 border-light shadow-sm">
                        <div className="wd-title p-3 ps-2 bg-light d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <div className="d-flex align-items-center mt-2 mt-sm-0">
                                ...
                                <AssignmentsControlButtons addAssignment={handleAddAssignment} />
                            </div>
                        </div>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <div className="text-muted mt-1">
                                                ...
                                                {format(new Date(assign.fromDate), "MMM d")} at 12:00am | <b>Due</b>{" "}
                                                {format(new Date(assign.dueDate), "MMM d")} at 11:59pm | {assign.points} pts
                                            </div>
                                        </div>
                                        <div className="d-flex align-items-center flex-nowrap">
