    ...
    return (
      <div id="wd-lab1">
        ...
        <div id="wd-h-tag">
          ...
          font of the section headings are usually arger and bolder than their 
          subsection headings. This document uses headings to introduce
          topics such as HTML Documents, HTML Tags, Heading Tags, etc. HTML heading tags 
        ...
        <div id="wd-p-tag"></div>
          <h4>Paragraph Tag</h4>
            ...
            scrambled it to make a type specimen book
              ...
              alt="Starship from StarAdvertiser"
              />
              <br />
                  ...
                  <input type="text" id="wd-text-fields-last-name" placeholder="Doe"
                    ...
                    <textarea id="wd-textarea" cols={30} rows={10}>
                      ...
                      <h5>Select many</h5>
                        ...
                        Favorite all movie genres: </label>
                        <br/>
